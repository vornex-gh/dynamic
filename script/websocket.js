  ...
  .then((e) => {
    ...
    if (e.data["listening_to_spotify"]) {
      ...
      document.getElementById("trackImg").src =
        "https://raw.githubusercontent.com/DGS1337/neksio/main/template/musicDefault.png";
    }
    ...
    if (e.data["activities"].length > 0) {
      ...
      document.getElementById(
        "rpcSmallIcon"
      ).src = `https://raw.githubusercontent.com/DGS1337/neksio/main/template/transparent.png`;
