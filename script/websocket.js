  ...
  .then((e) => {
    ...
    if (e.data["activities"].length > 0) {
      if (e.data["activities"][0].name == "Spotify") {    
        ...
        document.getElementById("rpcIcon").src = `https://cdn.discordapp.com/app-assets/153490292081819648/${e.data["activities"][1].assets.large_image}.png`;
        document.getElementById("rpcSmallIcon").src = `https://cdn.discordapp.com/app-assets/153490292081819648/${e.data["activities"][1].assets.small_image}.png`;
    } else {
      ...
      document.getElementById("rpcIcon").src = `https://cdn.discordapp.com/app-assets/153490292081819648/${e.data["activities"][0].assets.large_image}.png`;
      document.getElementById("rpcSmallIcon").src = `https://cdn.discordapp.com/app-assets/153490292081819648/${e.data["activities"][0].assets.small_image}.png`;
    }
    } else {
  ...
  if (data.t == "PRESENCE_UPDATE") {
    if (data.d.spotify) {
      ...
      if(data.d.activities[0].name == "Spotify"){
        ...
        document.getElementById("rpcIcon").src = `https://cdn.discordapp.com/app-assets/153490292081819648/${data.d["activities"][1].assets.large_image}.png`;
        document.getElementById("rpcSmallIcon").src = `https://cdn.discordapp.com/app-assets/153490292081819648/${data.d["activities"][1].assets.small_image}.png`;
      }
    } else {
      rpcName.innerText = "None"
      rpcDetails.innerText = "I'm not currently playing anything"
